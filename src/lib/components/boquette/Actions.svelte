<script lang="ts">
  ...
  import {
    exporterProduits,
    generateExcel,
  } from "$lib/components/boquette/ExportImportFeuilleRhopses";
...
<div
  class="btn-group self-center w-fit variant-filled-secondary divide-gray-400"
>
  ...
  {#if boquette.nom == "K've" || boquette.nom == "Auberge" || boquette.nom == "Foy's" || boquette.nom == "Mafia"|| boquette.nom == "Claq's" || boquette.nom == "Cock's"}
