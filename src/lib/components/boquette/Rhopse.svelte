...
<SectionCard title="Rhopse">
  <div class="flex rounded-md w-full justify-center divide-x-2 divide-red-600">
    <input
      ...
      class="p-1 outline-none text-black text-xs bg-red-100 w-1/2 placeholder-gray-500"
      type="number"
      placeholder="nums"
    />
    <input
    ...
    <svelte:fragment slot="PG" let:sIP>
      ...
      >
        <tr slot="tbody" let:e>
          ...
          <td
            ><a
              href="/boquette-{boquette.id_boquette}/rhopse-{e.pg.id_pg}"
              class="bg-gray-500 p-1 text-gray-300 rounded-lg">Rhopse</a
            ></td
          >
        </tr><tr />
      </CustomTable>
