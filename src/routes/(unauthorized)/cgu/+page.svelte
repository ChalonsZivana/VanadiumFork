...
<div id="bloc_historique" class="p-2 text-sm bg-white">
  ...
  <p>
    ...
    confiance dans l'économie numérique, il est précisé aux utilisateurs du site <a
      class="underline text-blue-500"
      href="http://myvanadium.com/">myvanadium.com</a
    > l'identité des différents intervenants dans le cadre de sa réalisation et de
    son suivi :
  </p>
  <p>
    <strong>Propriétaire</strong> : L'association des élèves de l'ENSAM de
    Châlons – rue Saint Dominique, Châlons en Champagne 51000<br />
    <strong>Créateurs</strong> : 63ch222<br />
    <strong>Inspiré du travail </strong> : Dartix 23Ch208, Scripter's 40Ch210,
    Kirik's 67Ch211, Er'Z't'S 16Ch212, Baïbeur 121Ch212, Quicky 3Ch213, Franklin
    58Ch213 et Fantal 92Ch214<br />
    <strong>Webmaster</strong> : L'association des élèves de l'ENSAM de Châlons
    –
    <a class="underline text-blue-500" href="mailto:info.ch@gadz.org"
      >info.ch@gadz.org</a
    ><br />
  ...
  <h2 class="text-lg">
    <strong
      >2. Conditions générales d’utilisation du site et des services proposés.</strong
    >
  </h2>
  <p>
    ...
    du site
    <a class="underline text-blue-500" href="http://myvanadium.com/"
      >myvanadium.com</a
  ...
  <p>
    ...
    décidée par l'association des élèves de l'ENSAM de Châlons, qui s’efforcera
    alors de communiquer préalablement aux utilisateurs les dates et heures de
    l’intervention.
  </p>
  <p>
    Le site <a class="underline text-blue-500" href="http://myvanadium.com/"
      >myvanadium.com</a
    > est mis à jour régulièrement par l'association des élèves de l'ENSAM de Châlons.
  ...
  <p>
    Le site <a class="underline text-blue-500" href="http://myvanadium.com/"
      >myvanadium.com</a
    > a pour objet de gérer les flux entre les différents élèves de l'ENSAM de Châlons.
  </p>
  <p>
    L'association des élèves de l'ENSAM de Châlons s’efforce de fournir sur le
    site <a class="underline text-blue-500" href="http://myvanadium.com/"
      >myvanadium.com</a
  ...
  <p>
    L'association des élèves de l'ENSAM de Châlons est propriétaire des droits
    de propriété intellectuelle ou détient les droits d’usage sur tous les
    éléments accessibles sur le site, notamment les textes, images, graphismes,
  ...
  <p>
    ...
    l'association des élèves de l'ENSAM de Châlons.
  </p>
  <p>
  ...
  <p>
    L'association des élèves de l'ENSAM de Châlons ne pourra être tenue
    responsable des dommages directs et indirects causés au matériel de
    l’utilisateur, lors de l’accès au site myvanadium.com, et résultant soit de
  ...
  <p>
    L'association des élèves de l'ENSAM de Châlons ne pourra également être
    tenue responsable des dommages indirects (tels par exemple qu’une perte de
  ...
  <p>
    ...
    contact) sont à la disposition des utilisateurs. L'association des élèves de
    l'ENSAM de Châlons se réserve le droit de supprimer, sans mise en demeure
    préalable, tout contenu déposé dans cet espace qui contreviendrait à la
    législation applicable en France, en particulier aux dispositions relatives
    à la protection des données. Le cas échéant, l'association des élèves de
    l'ENSAM de Châlons se réserve également la possibilité de mettre en cause la
  ...
  <p>
    En tout état de cause l'association des élèves de l'ENSAM de Châlons ne
    ...
    notamment lorsqu'il procède par lui-même à leur saisie. Il est alors précisé
  ...
  <p>
    Conformément aux dispositions des articles 38 et suivants de la loi 78-17 du
    6 janvier 1978 relative à l’informatique, aux fichiers et aux libertés, tout
    utilisateur dispose d’un droit d’accès, de rectification et d’opposition aux
    données personnelles le concernant, en effectuant sa demande écrite et
  ...
  <p>
    ...
    l'association des élèves de l'ENSAM de Châlons et de ses droits permettrait
    la transmission des dites informations à l'éventuel acquéreur qui serait à
  ...
  <p>
    ...
    place avec l’autorisation de l'association des élèves de l'ENSAM de Châlons.
    Cependant, l'association des élèves de l'ENSAM de Châlons n’a pas la possibilité
  ...
  <p>
    ...
    de l’utilisateur, mais qui enregistre des informations relatives à la navigation
  ...
  <p>
    Le refus d’installation d’un cookie peut entraîner l’impossibilité d’accéder
  ...
  <p>
    ...
    haut a droite) / options internet. Cliquez sur Confidentialité et choisissez
  ...
  <p>
    ...
    sur Paramètres de contenu. Dans la section "Cookies", vous pouvez bloquer
    les cookies.
  </p>
  <p>
    ...
    "Confidentialité", cliquez sur préférences. Dans l'onglet "Confidentialité",
  ...
  <p>
    ...
    6 août 2004 relative à l'informatique, aux fichiers et aux libertés.
  </p>
  <p>
