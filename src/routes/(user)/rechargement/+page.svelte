...
<div class="w-11/12 h-full mt-5 flex flex-col gap-5">
  ...
  <SectionCard title="Rechargement Fam's">
    <form action="?/rechargementFams" class="flex w-full flex-col gap-5">
      <label class="w-full text-xl">
        Montant:
        <input class="w-full text-black" type="number" name="montant" placeholder="À partir de ton compte.">
      </label>
      <label class="w-full text-xl">
        Libelle:
